...
import { Countries } from '../sells.module';
...
export class InformationComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.form = this.formBuilder.group({
      ...
      zipCode: ['', [Validators.required , Validators.minLength(5), Validators.maxLength(7), Validators.pattern(/^\d{5}(?:\d{2})?$/)]],
      mobilePhone: ['', [Validators.required , Validators.pattern(/^\+[1-9]{1}[0-9]{7,11}$/)]],
    });
    ...
    console.log(this.Countries[2].name)
